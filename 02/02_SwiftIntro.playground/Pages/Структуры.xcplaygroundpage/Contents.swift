...
let vsh2 = Holder(with: vs)

print("vs: \(vs.value) vsh1: \(vsh1.value.value) vsh2: \(vsh2.value.value)")
...
let vch2 = Holder(with: vc)

print("vc: \(vc.value) vch1: \(vch1.value.value) vch2: \(vch2.value.value)")
